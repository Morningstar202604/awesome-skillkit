...
- [Core Principles](#core-principles)
  ...
  - [2. Hierarchical Resource Structure](#2-hierarchical-resource-structure)
- [Resource Naming Conventions](#resource-naming-conventions)
  - [URLs Should Use Kebab-Case](#urls-should-use-kebab-case)
...
- [HTTP Methods Usage](#http-methods-usage)
  - [GET - Safe and Idempotent](#get-safe-and-idempotent)
...
- [URL Design Patterns](#url-design-patterns)
  - [Query Parameters for Filtering](#query-parameters-for-filtering)
...
- [Field Naming Conventions](#field-naming-conventions)
  - [Use camelCase for JSON Fields](#use-camelcase-for-json-fields)
  - [Boolean Fields](#boolean-fields)
  - [Date/Time Fields](#datetime-fields)
- [Content Negotiation](#content-negotiation)
  - [Accept Headers](#accept-headers)
  - [Content-Type Headers](#content-type-headers)
  - [Versioning via Headers](#versioning-via-headers)
- [Caching Guidelines](#caching-guidelines)
  - [Cache-Control Headers](#cache-control-headers)
  - [ETags for Conditional Requests](#etags-for-conditional-requests)
...
- [Hypermedia (HATEOAS)](#hypermedia-hateoas)
  - [Links in Responses](#links-in-responses)
  - [Link Relations](#link-relations)
- [Common Anti-Patterns to Avoid](#common-anti-patterns-to-avoid)
  - [1. Verbs in URLs](#1-verbs-in-urls)
  - [2. Inconsistent Naming](#2-inconsistent-naming)
  - [3. Deep Nesting](#3-deep-nesting)
  - [4. Ignoring HTTP Status Codes](#4-ignoring-http-status-codes)
  - [5. Exposing Internal Structure](#5-exposing-internal-structure)
  - [6. No Versioning Strategy](#6-no-versioning-strategy)
  - [7. Inconsistent Error Responses](#7-inconsistent-error-responses)
