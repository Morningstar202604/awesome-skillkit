...
- [1. Verb-Based URLs (The RPC Trap)](#1-verb-based-urls-the-rpc-trap)
  ...
  - [Solution](#solution)
- [2. Inconsistent Naming Conventions](#2-inconsistent-naming-conventions)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [3. Ignoring HTTP Status Codes](#3-ignoring-http-status-codes)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [4. Overly Complex Nested Resources](#4-overly-complex-nested-resources)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [5. Inconsistent Error Response Formats](#5-inconsistent-error-response-formats)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [6. Missing or Poor Pagination](#6-missing-or-poor-pagination)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [7. Exposing Internal Implementation Details](#7-exposing-internal-implementation-details)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [8. Overloading Single Endpoint](#8-overloading-single-endpoint)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [9. Lack of Versioning Strategy](#9-lack-of-versioning-strategy)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [10. Poor Error Messages](#10-poor-error-messages)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [11. Ignoring Content Negotiation](#11-ignoring-content-negotiation)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [12. Stateful API Design](#12-stateful-api-design)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [13. Inconsistent HTTP Method Usage](#13-inconsistent-http-method-usage)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [14. Missing Rate Limiting Information](#14-missing-rate-limiting-information)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [15. Chatty API Design](#15-chatty-api-design)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [16. No Input Validation](#16-no-input-validation)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [17. Synchronous Long-Running Operations](#17-synchronous-long-running-operations)
  - [Anti-Pattern](#anti-pattern)
  - [Why It's Bad](#why-its-bad)
  - [Solution](#solution)
- [Prevention Strategies](#prevention-strategies)
  - [1. API Design Reviews](#1-api-design-reviews)
  - [2. API Style Guides](#2-api-style-guides)
