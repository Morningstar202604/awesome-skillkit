...
- [Pattern Categories](#pattern-categories)
  ...
  - [2. Supervisor Pattern (Hierarchical Delegation)](#2-supervisor-pattern-hierarchical-delegation)
  - [3. Swarm Pattern (Peer-to-Peer)](#3-swarm-pattern-peer-to-peer)
  - [4. Hierarchical Pattern (Multi-Level Management)](#4-hierarchical-pattern-multi-level-management)
  - [5. Pipeline Pattern (Sequential Processing)](#5-pipeline-pattern-sequential-processing)
- [Pattern Selection Criteria](#pattern-selection-criteria)
  ...
  - [Fault Tolerance Requirements](#fault-tolerance-requirements)
- [Hybrid Patterns](#hybrid-patterns)
  - [Hub-and-Spoke with Clusters](#hub-and-spoke-with-clusters)
  - [Pipeline with Parallel Stages](#pipeline-with-parallel-stages)
  - [Hierarchical Swarms](#hierarchical-swarms)
- [Communication Patterns by Architecture](#communication-patterns-by-architecture)
...
- [Best Practices by Pattern](#best-practices-by-pattern)
  - [Single Agent](#single-agent)
  - [Supervisor](#supervisor)
  - [Swarm](#swarm)
  - [Hierarchical](#hierarchical)
...
- [Anti-Patterns to Avoid](#anti-patterns-to-avoid)
  - [God Agent](#god-agent)
  - [Chatty Communication](#chatty-communication)
  - [Circular Dependencies](#circular-dependencies)
  - [Over-Centralization](#over-centralization)
