...
- [Authentication Patterns](#authentication-patterns)
  - [Login — Happy Path](#login-happy-path)
  - [Login — Invalid Credentials](#login-invalid-credentials)
  - [Login — Account Locked](#login-account-locked)
  - [Token Refresh](#token-refresh)
  - [Logout](#logout)
- [CRUD Patterns](#crud-patterns)
  - [Create](#create)
  - [Create — Validation Failure](#create-validation-failure)
  - [Read — Single Item](#read-single-item)
  - [Read — Not Found](#read-not-found)
  - [Update](#update)
  - [Update — Ownership Check](#update-ownership-check)
  - [Delete — Soft Delete](#delete-soft-delete)
  - [List — Pagination](#list-pagination)
  - [List — Filtered](#list-filtered)
- [Search Patterns](#search-patterns)
  - [Basic Search](#basic-search)
  - [Search — Empty Results](#search-empty-results)
  - [Search — Special Characters](#search-special-characters)
- [File Upload Patterns](#file-upload-patterns)
  - [Upload — Happy Path](#upload-happy-path)
  - [Upload — Size Exceeded](#upload-size-exceeded)
  - [Upload — Invalid Type](#upload-invalid-type)
- [Payment Patterns](#payment-patterns)
  - [Charge — Happy Path](#charge-happy-path)
  - [Charge — Declined](#charge-declined)
  - [Charge — Idempotency](#charge-idempotency)
- [Notification Patterns](#notification-patterns)
  - [Email Notification](#email-notification)
  - [Notification — Delivery Failure](#notification-delivery-failure)
- [Negative Test Patterns](#negative-test-patterns)
  - [Unauthorized Access](#unauthorized-access)
  - [Invalid Input — Type Mismatch](#invalid-input-type-mismatch)
  - [Rate Limiting](#rate-limiting)
  - [Concurrent Modification](#concurrent-modification)
- [Performance Criteria Patterns](#performance-criteria-patterns)
  - [Response Time](#response-time)
  - [Throughput](#throughput)
  - [Resource Usage](#resource-usage)
- [Accessibility Criteria Patterns](#accessibility-criteria-patterns)
