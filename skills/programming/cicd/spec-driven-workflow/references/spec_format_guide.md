...
- [Section 2: Context](#section-2-context)
  - [What to Include](#what-to-include)
  - [What to Exclude](#what-to-exclude)
  - [Good Example](#good-example)
  - [Bad Example](#bad-example)
- [Section 3: Functional Requirements — RFC 2119](#section-3-functional-requirements-rfc-2119)
  ...
  - [Bad Requirements](#bad-requirements)
- [Section 4: Non-Functional Requirements](#section-4-non-functional-requirements)
  - [Categories](#categories)
- [Section 5: Acceptance Criteria — Given/When/Then](#section-5-acceptance-criteria-givenwhenthen)
  - [The Given/When/Then Pattern](#the-givenwhenthen-pattern)
  - [Rules for Acceptance Criteria](#rules-for-acceptance-criteria)
  - [Example: Authentication Feature](#example-authentication-feature)
  - [Common Mistakes](#common-mistakes)
- [Section 6: Edge Cases and Error Scenarios](#section-6-edge-cases-and-error-scenarios)
  - [What Counts as an Edge Case](#what-counts-as-an-edge-case)
  - [Format](#format)
  - [Coverage Rule](#coverage-rule)
- [Section 7: API Contracts](#section-7-api-contracts)
  - [Notation](#notation)
  - [What to Define](#what-to-define)
  - [Error Response Convention](#error-response-convention)
- [Section 8: Data Models](#section-8-data-models)
  - [Table Format](#table-format)
  - [Rules](#rules)
- [Section 9: Out of Scope](#section-9-out-of-scope)
  - [Why This Section Matters](#why-this-section-matters)
  - [Format](#format)
  - [Rules](#rules)
- [Feature-Type Templates](#feature-type-templates)
  - [CRUD Feature](#crud-feature)
  - [Integration Feature](#integration-feature)
  - [Migration Feature](#migration-feature)
- [Checklist: Is This Spec Ready for Review?](#checklist-is-this-spec-ready-for-review)
- [Full Example: Password Reset](#full-example-password-reset)
  - [The Spec](#the-spec)
  - [Extracted Test Cases](#extracted-test-cases)
