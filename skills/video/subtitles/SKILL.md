...
description: "Generate SRT subtitles and platform-optimized captions from video script. Supports multi-language, timing sync, and per-platform caption formats. Use after script is finalized, before or during final assembly."
license: Apache-2.0
