...
description: "Design and generate video thumbnails/covers optimized for each platform. Supports text overlay, character placement, and platform-specific sizing. Use as final step before publishing."
license: Apache-2.0
