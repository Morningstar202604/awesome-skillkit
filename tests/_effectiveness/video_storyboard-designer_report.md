...
- 长度混淆：新版在 2/3 个样本上更长（中位 3426 vs 3604 字符）——评委指令禁止按篇幅加分，但该混淆不可完全排除
...
## 明细
### 任务 product-ad-16x9
- sample 1: verdict=**tie** (换序 ['old', 'new']) ｜ gate old=OK / new=OK ｜ chars=[3700, 3604]
### 任务 vertical-15s-twist
- sample 1: verdict=**new** (换序 ['new', 'new']) ｜ gate old=OK / new=OK ｜ chars=[3426, 3466]
### 任务 script-to-board-consistency
- sample 1: verdict=**new** (换序 ['new', 'new']) ｜ gate old=['长度不足（62 < 250）'] / new=OK ｜ chars=[62, 4051]