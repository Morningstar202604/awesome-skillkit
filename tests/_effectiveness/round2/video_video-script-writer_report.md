...
- 长度混淆：新版在 3/3 个样本上更长（中位 969 vs 1234 字符）——评委指令禁止按篇幅加分，但该混淆不可完全排除

| 任务 | 最终裁决 | old/new/tie/invalid |
|---|---|---|
| douyin-30s-oral | **new** | 0/1/0/0 |
...
## 明细
### 任务 douyin-30s-oral
- sample 1: verdict=**new** (换序 ['new', 'new']) ｜ gate old=OK / new=OK ｜ chars=[958, 1206]
### 任务 bilibili-60s-tutorial
- sample 1: verdict=**invalid** (换序 ['invalid', 'new']) ｜ gate old=OK / new=OK ｜ chars=[1577, 2281]
### 任务 meme-15s-loop
- sample 1: verdict=**old** (换序 ['old', 'old']) ｜ gate old=OK / new=OK ｜ chars=[969, 1234]